...
public class Bytes {
  ...
  public static String toHex(byte[] b) {
    if(b.length <= 0) throw new IllegalArgumentException("length must be greater than 0");
  ...
  public static byte[] fromHex(String hex) {
    if(hex.length() <= 0) throw new IllegalArgumentException("length must be greater than 0");
    if(hex.length() % 2 != 0) throw new IllegalArgumentException("length must be a multiple of 2");
