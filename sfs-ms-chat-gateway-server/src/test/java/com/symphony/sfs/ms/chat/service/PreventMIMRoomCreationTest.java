...
public class PreventMIMRoomCreationTest {
  ...
  public void setUp() throws Exception {
    ...
    messageService = new MessageService(empClient, federatedAccountRepository, forwarderQueueConsumer, datafeedSessionPool, streamService, podConfiguration);
  ...
  public void onUserJoinedRoom() throws Exception {
    ...
    doNothing().when(roomService).removeMemberFromRoom("KdO82B8UMTU7og2M4vOFqn///pINMV/OdA==", session);
    ...
    verify(roomService, times(1)).removeMemberFromRoom("KdO82B8UMTU7og2M4vOFqn___pINMV_OdA", session);
